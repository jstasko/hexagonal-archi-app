package sk.stasko.order.system.kafka.consumer.config;
...
import sk.stasko.order.service.config.data.KafkaConfigData;
import sk.stasko.order.service.config.data.KafkaConsumerConfigData;
